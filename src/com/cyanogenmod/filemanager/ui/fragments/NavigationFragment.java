...
public class NavigationFragment extends Fragment
            ...
            switch (v.getId()) {
                case R.id.drawer_bookmarks_tab:
                    if (!mBookmarksTab.isSelected()) {
                        ...
                        mBookmarksTab.setTextAppearance(getActivity(),
                                R.style.primary_text_appearance);
                        mHistoryTab.setTextAppearance(getActivity(),
                                R.style.secondary_text_appearance);
     ...
     * @hide
     */
    static Map<MimeTypeHelper.MimeTypeCategory, Drawable> EASY_MODE_ICONS = new
            HashMap<MimeTypeHelper.MimeTypeCategory, Drawable>();
    ...
    private void initTitleActionBar() {
        ...
        NavigationCustomTitleView title =
                (NavigationCustomTitleView) mTitleLayout.findViewById(
    ...
    private void onLayoutChanged() {
        ...
        if (mStatusBar != null) {
            ...
            if (this.mOrientation == Configuration.ORIENTATION_LANDSCAPE) {
                ...
                // Apply theme
                mStatusBar.setBackgroundResource(R.drawable.titlebar_drawable); //$NON-NLS-1$
                ...
                // Apply theme
                mStatusBar.setBackgroundResource(R.drawable.statusbar_drawable); //$NON-NLS-1$
    ...
    void applyTheme() {
        ...
        mSearchView = (SearchView) mTitleLayout.findViewById(
        ...
        theme.setImageDrawable(getActivity(),
                (ImageView)v, "ab_overflow_drawable"); //$NON-NLS-1$
        v = mView.findViewById(R.id.ab_actions);
        theme.setImageDrawable(getActivity(),
                (ImageView)v, "ab_actions_drawable"); //$NON-NLS-1$
        v = mView.findViewById(R.id.ab_search);
        theme.setImageDrawable(getActivity(),
                (ImageView)v, "ab_search_drawable"); //$NON-NLS-1$

        //- Expanders
        v = mTitleLayout.findViewById(R.id.ab_configuration);
        theme.setImageDrawable(getActivity(),
                (ImageView)v, "expander_open_drawable"); //$NON-NLS-1$
        ...
        theme.setImageDrawable(getActivity(),
                (ImageView)v, "ab_sort_mode_drawable"); //$NON-NLS-1$
        ...
        theme.setBackgroundDrawable(getActivity(),
                v, "selectionbar_drawable"); //$NON-NLS-1$
