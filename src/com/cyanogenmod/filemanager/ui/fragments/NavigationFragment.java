...
public class NavigationFragment extends Fragment
    ...
    public void openActionsDialog(final Object item, final boolean global) {
        ...
        if (mOpenActionsDialogAsyncTask == null ||
            ...
            mOpenActionsDialogAsyncTask = new AsyncTask<Object, Void, Boolean>() {
                ...
                protected Boolean doInBackground(Object... params) {
                    ...
                    mFso = null;
                    try {
                        mFso = CommandHelper.getFileInfo(getActivity(), path, false, null);
                        if (mFso == null) {
                ...
                @Override
                protected void onPostExecute(final Boolean fso) {
                    if (progressDialog.isShowing()) {
                        progressDialog.dismiss();
                    }
                    // Show the dialog
                    ActionsDialog dialog =
                            new ActionsDialog(getActivity(), backRef, mFso, global, false);
