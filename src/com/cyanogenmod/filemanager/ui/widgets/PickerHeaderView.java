...
public class PickerHeaderView extends LinearLayout {
    ...
    private void init() {
        ...
        mTransition = TransitionInflater.from(getContext()).inflateTransition(
                R.transition.picker_header_transition);
        mCurrentScene = mRootTitleScene;
        TransitionManager.go(mCurrentScene);

        mToolbar = (Toolbar) content.findViewById(R.id.picker_toolbar);
        mToolbar.inflateMenu(R.menu.picker_menu);
    ...
    public void showMenu(boolean show) {
        //mToolbar.getMenu().findItem(R.id.mnu_new_folder).setVisible(show);
    }
