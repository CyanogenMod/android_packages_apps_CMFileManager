...
public class MenuBuilder implements Menu {
    ...
    private static int getOrdering(int categoryOrder) {
        int CATEGORY_MASK = CompatUtils.getClsHideIntStaticField(Menu.class, "CATEGORY_MASK", 0xffff0000);
		int CATEGORY_SHIFT = CompatUtils.getClsHideIntStaticField(Menu.class, "CATEGORY_SHIFT", 16);
		int USER_MASK = CompatUtils.getClsHideIntStaticField(Menu.class, "USER_MASK", 0x0000ffff);
...
//        return (sCategoryToOrder[index] << CATEGORY_SHIFT) | (categoryOrder & USER_MASK);
    ...
    private void setShortcutsVisibleInner(boolean shortcutsVisible) {
        mShortcutsVisible = shortcutsVisible
                ...
                && CompatUtils.getInternalBoolean(mResources, "config_showMenuShortcutsWhenKeyboardPresent");
