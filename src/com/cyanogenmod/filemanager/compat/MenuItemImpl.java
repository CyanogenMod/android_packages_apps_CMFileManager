...
public final class MenuItemImpl implements MenuItem {
    ...
    MenuItemImpl(MenuBuilder menu, int group, int id, int categoryOrder, int ordering,
        ...
        if (sPrependShortcutLabel == null || !lang.equals(sLanguage)) {
            ...
            Resources res = menu.getContext().getResources();
            sPrependShortcutLabel = CompatUtils.getInternalString(res, "prepend_shortcut_label");
            sEnterShortcutLabel = CompatUtils.getInternalString(res, "menu_enter_shortcut_label");
            sDeleteShortcutLabel = CompatUtils.getInternalString(res, "menu_delete_shortcut_label");
            sSpaceShortcutLabel = CompatUtils.getInternalString(res, "string.menu_space_shortcut_label");
