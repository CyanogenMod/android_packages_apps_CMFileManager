...
public class NavigationActivity extends ActionBarActivity
    ...
    // TODO: Replace with legitimate colors.
    int[] colors = new int[] {
            Color.BLACK,
            Color.RED,
            Color.GREEN,
            ...
            switch (view.getId()) {
                ...
                case com.cyanogenmod.filemanager.R.id.ab_sort_mode:
                    nFrag.showSettingsPopUp(view,
                            java.util.Arrays.asList(
                                    new com.cyanogenmod.filemanager.preferences.FileManagerSettings[]{
                                            com.cyanogenmod.filemanager.preferences.FileManagerSettings.SETTINGS_SORT_MODE}));
                    break;
                case com.cyanogenmod.filemanager.R.id.ab_layout_mode:
                    nFrag.showSettingsPopUp(view,
                            java.util.Arrays.asList(
                                    new com.cyanogenmod.filemanager.preferences.FileManagerSettings[]{
                                            com.cyanogenmod.filemanager.preferences.FileManagerSettings.SETTINGS_LAYOUT_MODE}));
                    break;
                case com.cyanogenmod.filemanager.R.id.ab_view_options:
                    ...
                    if (nFrag.mChRooted) {
                        nFrag.showSettingsPopUp(view,
                                java.util.Arrays
                                        .asList(new com.cyanogenmod.filemanager.preferences.FileManagerSettings[]{
                                                com.cyanogenmod.filemanager.preferences.FileManagerSettings.SETTINGS_SHOW_DIRS_FIRST}));
                    } else {
                        nFrag.showSettingsPopUp(view,
                                java.util.Arrays
                                        .asList(new com.cyanogenmod.filemanager.preferences.FileManagerSettings[]{
                                                com.cyanogenmod.filemanager.preferences.FileManagerSettings.SETTINGS_SHOW_DIRS_FIRST,
                                                com.cyanogenmod.filemanager.preferences.FileManagerSettings.SETTINGS_SHOW_HIDDEN,
                                                com.cyanogenmod.filemanager.preferences.FileManagerSettings.SETTINGS_SHOW_SYSTEM,
                                                com.cyanogenmod.filemanager.preferences.FileManagerSettings.SETTINGS_SHOW_SYMLINKS}));
                    }
