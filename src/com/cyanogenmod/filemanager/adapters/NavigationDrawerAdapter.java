    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (item.getType()) {
            ...
            case DOUBLE:
                ...
                itemIcon = (ImageView) convertView.findViewById(R.id.navigation_drawer_item_icon);
                itemTitle = (TextView) convertView.findViewById(R.id.navigation_drawer_item_title);
                itemSummary = (TextView) convertView.findViewById(R.id.navigation_drawer_item_summary);
                break;
            case DIVIDER:
        ...
        if (itemIcon != null) {
            ...
            itemIcon.setColorFilter(R.color.navigation_drawer_icon_default, Mode.MULTIPLY);
        }
        if (itemTitle != null) {
